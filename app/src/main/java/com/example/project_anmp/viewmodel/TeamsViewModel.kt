...
class TeamsViewModel(application: Application) : AndroidViewModel(application), CoroutineScope {
    ...
    fun refresh(gameName: String) {
        ...
        launch {
            ...
            try {
                val allTeams = db.teamDao().getTeamsByGame(gameName) // Fetch all teams
